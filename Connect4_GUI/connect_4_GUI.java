...
public class connect_4_GUI extends JFrame{
	...
	public connect_4_GUI() {
		...
		turnDis = new JLabel("Player 1 Score= " + Player1.getNumWins()+ "     " + "Player 2 Score= " + Player2.getNumWins() +"     " + "Total Games Played= " + 0);
	...
	private class Connect4Board extends JPanel implements Connect_4_Interface, Connect_4_Player_Interface, ActionListener{
		...
		public void actionPerformed(ActionEvent e) {
		 ...
		 turnDis.setText("Player 1 Score= " + Player1.getNumWins()+ "     " + "Player 2 Score= " + Player2.getNumWins() +"     " + "Total Games Played= " + totalGamesPlayed);
